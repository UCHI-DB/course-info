...
In the lab assignments in 23500
...
6. The last thing that we strongly recommend you do is to go to the
   ...
   `https://github.com/UCHI-DB/hw-answers-(your student name)/tree/lab1`
...
Please submit (friendly!) bug reports to [aelmore@cs.uchicago.edu](mailto:aelmore@cs.uchicago.edu).
